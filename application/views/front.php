		  ...
		  <div class="col-lg-6">
			<div class="box <?php
			  ...
			  ?>"></i>
                ...
                <div class="box-body">
					<center><img class="img-responsive" src="<?php echo base_url(); ?>assets/uploads/logo/<?php echo $this->session->userdata('logo');?>" />
					<br><a class="btn btn-flat btn-primary" id="reg" href="<?php echo base_url();?>front/pengumuman">Pengumuman Guru Terbaik</a></center>
                </div>
