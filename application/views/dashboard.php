					...
					<div class="row">
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-green">
							<div class="inner">
							  <h3><?php echo $this->session->userdata('jml_guru');?></h3>
							...
							<a href="<?php echo site_url('dashboard/guru')?>" class="small-box-footer">
						...
						<div class="col-lg-3 col-xs-6">
						  ...
						  <div class="small-box bg-red">
							<div class="inner">
							  ...
							  <p>Setting <?php echo $this->session->userdata('judul');?></p>
							</div>
							<div class="icon">
					  ...
					  <div class="row">
						<div class="col-lg-12 text-center">
							<h3>Selamat datang pada <br> <?php echo $this->session->userdata('judul')." - ".$this->session->userdata('desc')?></h3> 
							Silahkan Anda melakukan penilaian terhadap guru terpilih, untuk menentukan guru terbaik dengan mempergunakan <?php echo $this->session->userdata('judul')." - ".$this->session->userdata('desc')?>.
						</div>
					  </div>
					  <?php } ?>
                </div>
