        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<?php if($this->session->userdata('jt')=='admin'){ ?>
				<li <?php if($this->session->userdata('option')=='guru') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/guru')?>"><i class="fa fa-users"></i> Data Guru</a></li>
				<li <?php if($this->session->userdata('option')=='kriteria') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/kriteria')?>"><i class="fa fa-tag"></i> Data Kriteria</a></li>
				<li <?php if($this->session->userdata('option')=='sub kriteria') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/sub_kriteria')?>"><i class="fa fa-file-o"></i> Data Sub Kriteria</a></li>
				<li <?php if($this->session->userdata('option')=='periode') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/periode')?>"><i class="fa fa-calendar"></i> Data Periode</a></li>
				<li <?php if($this->session->userdata('option')=='penilaian') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/penilaian')?>"><i class="fa fa-edit"></i> Data Penilaian</a></li>
				<li <?php if($this->session->userdata('option')=='guru terpilih') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/guru_terpilih')?>"><i class="fa fa-star"></i> Guru Terpilih</a></li>
				<li <?php if($this->session->userdata('option')=='perhitungan') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/perhitungan')?>" target="blank"><i class="fa fa-tasks"></i> Perhitungan</a></li>
				<li <?php if($this->session->userdata('option')=='user') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/user')?>"><i class="fa fa-user"></i> Data User</a></li>
				 <li class="<?php if($this->session->userdata('option')=='setting'||$this->session->userdata('option')=='setting web') echo 'active';?>">
				  <a href="<?php echo base_url();?>dashboard/setting">
					<i class="fa fa-cogs"></i> <span>Setting</span>
				  </a>
				</li>
			<?php    } ?>
			<?php if($this->session->userdata('jt')=='kepsek'){ ?>
				<li <?php if($this->session->userdata('option')=='beri penilaian') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/beri_penilaian')?>"><i class="fa fa-edit"></i> Beri Penilaian</a></li>
				<li <?php if($this->session->userdata('option')=='perhitungan') echo 'class="active"';?>><a href="<?php echo site_url('dashboard/perhitungan')?>" target="blank"><i class="fa fa-tasks"></i> Hasil Perhitungan</a></li>
			<?php    } ?>
          </ul>
        </section>
        <!-- /.sidebar -->
            ...
            <section class="col-lg-12 connectedSortable">
			  ...
			  ?>">
                <div class="box-header">
                  <i class="fa 
				  <?php 
					if($this->session->userdata('option')=='guru') echo 'fa-users';
					if($this->session->userdata('option')=='kriteria') echo 'fa-tag';
					if($this->session->userdata('option')=='sub kriteria') echo 'fa-file-o';
					if($this->session->userdata('option')=='periode') echo 'fa-calendar';
					if($this->session->userdata('option')=='penilaian') echo 'fa-edit';
					if($this->session->userdata('option')=='guru terpilih') echo 'fa-star';
					...
					if($this->session->userdata('option')=='beri penilaian') echo 'fa-edit';
				  ?> 
				  <?php
			  ...
			  ?>"></i>
                  <h3 class="box-title">
				  <?php if($this->session->userdata('option')=='setting')
					       echo ucwords($this->session->userdata('option'));
					    else if($this->session->userdata('option')=='beri penilaian')
					       echo ucwords($this->session->userdata('option'));
					    else
