        ...
        <div class="container-fluid">
		  ...
		  <div class="col-lg-12">
			<div class="box <?php
			  ...
			  ?>"></i>
					 <h3 class="box-title">Perhitungan Alternatif Guru Terbaik</h3>
                </div>
                <div class="box-body">
				<div class="text-right"><button class="btn btn-primary btn-sm" onclick="myFunction()">Print</button>
				<a class="btn btn-primary btn-sm" id="report" href="<?php echo base_url();?>dashboard/laporan" target="_blank">Report</a></div>
					<center>
					<?php
					...
					?>
							...
							<form role="form" method="post" action="<?php echo base_url(); ?>dashboard/perhitungan">
					...
					echo "Berikut ini hasil analisa diurutkan berdasarkan hasil nilai tertinggi. </br>Jadi dapat disimpulkan bahwa Alternatif Guru Terbaik adalah <b>".ucwords(($hsl[0][0]))."</b> dengan nilai <b>".round($hsl[0][1],$r)."</b>.";
					echo "<table class='table table-striped table-bordered table-hover'>";
                ...
                <div class="box-footer clearfix text-center">
                  <b><?php echo $this->session->userdata('judul');?> - <?php echo $this->session->userdata('desc');?></b>
                </div>
              </div>
		  </div>
		  </div><!-- row -->
